...
def net(input, class_dim=10):
    ...
    conv1 = conv_block(resize_input, 64, 2, name="conv1_")
    conv2 = conv_block(conv1, 128, 2, name="conv2_")
    conv3 = conv_block(conv2, 256, 3, name="conv3_")
    conv4 = conv_block(conv3, 512, 3, name="conv4_")
    conv5 = conv_block(conv4, 512, 3, name="conv5_")	
